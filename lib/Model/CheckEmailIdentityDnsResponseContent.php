 ...
 */
class CheckEmailIdentityDnsResponseContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckEmailIdentityDnsResponseContent';
